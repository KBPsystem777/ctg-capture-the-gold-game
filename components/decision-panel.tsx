          ...
          <div className="flex items-start gap-4 p-4 rounded-xl bg-background border border-border shadow-sm">
            {evaluation.regulatorCorrect ? (
              <>
                ...
                <div>
                  <p className="font-bold text-foreground text-lg text-green-700">Correct Decision!</p>
              ...
              <div className="rounded-xl border border-border overflow-hidden min-w-[300px]">
                <table className="w-full text-xs text-left">
                  <thead className="bg-[#005D9F] text-white">
                    <tr>
                      <th className="px-4 py-3 font-semibold uppercase tracking-wider">Layer</th>
                      <th className="px-3 py-3 font-semibold uppercase tracking-wider text-center">Persuade</th>
                      <th className="px-3 py-3 font-semibold uppercase tracking-wider text-center">Lie</th>
                      <th className="px-3 py-3 font-semibold uppercase tracking-wider text-center">Decide</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-border bg-transparent">
                    <tr className="bg-background/40">
                      ...
                      <td className="px-3 py-3 text-center text-green-600 font-bold">✅</td>
                      <td className="px-3 py-3 text-center text-green-600 font-bold">✅</td>
                      <td className="px-3 py-3 text-center text-red-500 font-bold">❌</td>
                    </tr>
                    <tr className="bg-background/40">
                      <td className="px-4 py-3 text-foreground font-medium">
                        Documents
                    ...
                    <tr className="bg-primary/5 font-bold">
                      ...
                      <td className="px-3 py-4 text-center text-red-500 font-bold">❌</td>
                      <td className="px-3 py-4 text-center text-red-500 font-bold">❌</td>
      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          <div className="p-4 rounded-xl bg-primary/5 border border-primary/10 text-sm text-foreground leading-relaxed">
            ...
            Review the ledger entries against the claim before making your call. Trust the ledger, not persuasion.
          </div>
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span className="text-[10px] opacity-80 uppercase tracking-widest font-medium">Payment</span>
                </>
              )}
            </Button>
            <Button
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span className="text-[10px] opacity-80 uppercase tracking-widest font-medium">Claim</span>
                </>
              )}
            </Button>
          </div>
