          ...
          <>
                ...
                {ledger.map((tx) => (
                  <div key={tx.id} className="bg-secondary p-3 rounded border border-border">
                    <div className="flex justify-between items-start mb-2">
                      <p className="font-mono text-xs font-bold text-primary">{tx.id}</p>
                      <Badge
                        variant="secondary"
                        className={`text-xs ${
                          tx.status === 'confirmed'
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs">
                      <div>
                        ...
                        <p className="font-semibold text-foreground">{tx.gold_weight_kg} kg</p>
                      </div>
                      <div>
                        <p className="text-muted-foreground">Date</p>
                        <p className="font-semibold text-foreground">{tx.date}</p>
                      </div>
                      <div className="col-span-2">
                        <p className="text-muted-foreground">Location</p>
                        <p className="font-semibold text-foreground">{tx.location}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="border-t border-border pt-3 mt-3">
              <p className="text-xs text-muted-foreground">
                ⚠️ <strong>The ledger is your source of truth.</strong> Use it to verify if
                claims match recorded transactions.
              </p>
            </div>
          </>
        )}
